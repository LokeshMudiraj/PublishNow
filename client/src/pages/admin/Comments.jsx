...
import CommentsTableBody from '../../components/admin/CommentsTableBody'
      ...
      <div className='relative h-4/5 max-w-3xl overflow-x-auto mt-4 bg-white shadow rounded-lg scrollbar-hide'>
         <table className='w-full text-sm text-gray-500'>
            ...
            <tbody>
                ...
                }).map((comment, index)=><CommentsTableBody key={comment._id} comment={comment} index={index+1} fetchComments={fetchCommnets} />)}
            </tbody>
         </table>
      </div>
    </div>
